...
public class FirstFourAchievement extends Achievement {
	...
	public String getAchievementDesc() {
		return "Be the first to arrive in every round of league #4 and win the league";
	}

	@Override
	public Integer getAchievementId() {
		return AchievementConstants.ACHIEVE_FIRST_FOUR_ID;
	}
