...
public class FirstOneAchievement extends Achievement {
	...
	public String getAchievementDesc() {
		return "Be the first to arrive in every round of league #1 and win the league";
	}

	@Override
	public Integer getAchievementId() {
		return AchievementConstants.ACHIEVE_FIRST_ONE_ID;
	}
