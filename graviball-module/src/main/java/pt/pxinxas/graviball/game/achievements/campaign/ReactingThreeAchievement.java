...
public class ReactingThreeAchievement extends Achievement {
	...
	public String getAchievementName() {
		return "Reacting Three";
	}

	@Override
	public String getAchievementDesc() {
		return "Be the first to react in every round of league #3 and win the league";
	}

	@Override
	public Integer getAchievementId() {
		return AchievementConstants.ACHIEVE_REACTING_THREE_ID;
	}
