...
public class ReactingTwoAchievement extends Achievement {
	...
	public String getAchievementDesc() {
		return "Be the first to react in every round of league #2 and win the league";
	}

	@Override
	public Integer getAchievementId() {
		return AchievementConstants.ACHIEVE_REACTING_TWO_ID;
	}
